			...
			<div class="container h-full">
				<div class="flex flex-col justify-between h-full py-10">
					<div class="grid grid-cols-[1fr_2fr_1fr] gap-5">
						<div class="bg-gray-200 dark:bg-gray-700 rounded-xl p-4 h-96">Router</div>
						<div class="bg-gray-200 dark:bg-gray-700 rounded-xl p-4 h-96">Routing</div>
						<div class="bg-gray-200 dark:bg-gray-700 rounded-xl p-4 h-96">Contacts</div>
					</div>

					<div class="px-5">Quick Links</div>
				</div>
			</div>
		</div>
	</div>
