...
<template>
  <div
    ...
    :class="[
      'hidden overflow-hidden lg:block absolute z-40 w-full transform transition-all duration-300 ease-out',
      `h-[calc(100dvh-62px)] xl:h-[calc(100dvh-var(--header-height))] `,
      open ? 'translate-y-0 top-full' : '-translate-y-full top-0',
    ]"
  >
    <div
      class="h-full bg-gradient-to-b from-white via-white/95 to-white dark:from-gray-800/80 dark:via-gray-800/90 dark:to-gray-800"
    >
