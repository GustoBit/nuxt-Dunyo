...
<template>
	<header class="mb-5 xl:mb-6 sticky top-0 z-50 bg-gradient-to-b from-white900 via-white900/90 to-white900/80 dark:from-gray-800 dark:via-gray-800/90 dark:to-gray-800/80">
			...
			<div class="container relative z-50">
				<div class="flex items-center">
					...
					<div class="flex items-center gap-2 sm:gap-3 ml-auto">
						...
						>
							<p class="text-white900 medium text-lg leading-[100%] text-center">
								{{ $t('contacts') }}
							</p>
						</NuxtLink>
