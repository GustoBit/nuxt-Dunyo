...
<template>
  <header
    class="mb-5 xl:mb-6 sticky top-0 z-50 bg-gradient-to-b from-white900 via-white900/90 to-white900/80 dark:from-gray-800 dark:via-gray-800/90 dark:to-gray-800/80"
  >
    <div
      :class="[
        'relative py-2',
        isScrolled ? 'xl:pt-2 shadow' : 'xl:pt-8',
